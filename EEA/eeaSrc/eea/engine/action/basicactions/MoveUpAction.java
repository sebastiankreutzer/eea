...
/**
 * A MoveUpAction is an action used to model a upwards move of an entity.
 * 
 ...
 * @version 1.0
 */
public class MoveUpAction extends Movement implements Action {

  /**
   * Creates a new MoveUpAction with the concrete movement speed passed in.
   * 
   * @param speed
   ...
   */
  public MoveUpAction(float speed) {
    super(speed);
  }
