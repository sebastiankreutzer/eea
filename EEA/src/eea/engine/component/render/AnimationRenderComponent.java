...
public class AnimationRenderComponent extends RenderComponent {
   ...
   *          over or not.
   */
  public AnimationRenderComponent(Image[] frames, float speed, float width,
      float height, boolean looping) {
  ...
  public void render(GameContainer gc, StateBasedGame sb,
    ...
    if (!animation.isStopped())
      animation.draw(getOwnerEntity().getPosition().x, getOwnerEntity()
          .getPosition().y, size.x, size.y);
  }
