...
/**
 * A RotateLeftAction is an action used to model the rotation of an entity to the left,
 * more precisely: in clockwise direction.
 * 
...
public class RotateRightAction extends Movement{
  ...
  /**
   * Creates a new RotateRightAction with the concrete rotation speed passed in.
   * 
   * @param speed
  ...
  /**
   * RotateRightAction overrides the
   ...
   */
    ...
    // to the right, increase the angle accordingly
