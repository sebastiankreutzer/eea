 ...
 *
 */
public abstract class EEACollisionTriggerComponent extends EEAComponent {
	 ...
	 *            The component ID.
	 */
	public EEACollisionTriggerComponent(String componentID) {
		super(componentID);
	}
	 ...
	 * {@link EEACollisionTriggerComponent}.
	 * 
	 * @param other
	 *            The other CollisionComponent.
	 * @return true if the components collide, otherwise false.
	 */
	public abstract boolean collide(EEACollisionTriggerComponent other);

	/**
	 * Determines whether this CollisionComponent collides with another
	 * {@link BorderCollisionComponent}.
	 * 
	 * @param other
