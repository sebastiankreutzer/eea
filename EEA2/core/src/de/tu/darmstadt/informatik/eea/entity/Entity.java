 ...
 * {@link de.tu.darmstadt.informatik.eea.entity.EEAComponent} can be used to
 * determine the specific behavior of any entity, a special
 * {@link de.tu.darmstadt.informatik.eea.entity.RenderComponent} determines how
...
public class Entity extends Actor {
	...
	/**
	 * Adds a {@link de.tu.darmstadt.informatik.eea.entity.EEAComponent} to the
	 * components of this entity. If this component is a
	 * {@link de.tu.darmstadt.informatik.eea.entity.RenderComponent} the
...
/*
	...
	public Shape getShape() {
		Shape shape = new Rectangle.Float(getX(), getY(), getWidth()
				* getScaleX(), getHeight() * getScaleY());
		AffineTransform at = new AffineTransform();
		at.rotate(Math.toRadians(getRotation()), getOriginX() + getX(),
				getOriginY() + getY());
