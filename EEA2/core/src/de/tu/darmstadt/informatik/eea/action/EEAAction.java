...
/**
 * EEAActions are used to alter or act a {@link de.tu.darmstadt.informatik.eea.entity.Entity}.
 * Each action has one actor and may have a target entity. Actions can be added to a {@link de.tu.darmstadt.informatik.eea.event.EEAEvent}.
...
public abstract class EEAAction extends Action {
	...
	/**
	 * Returns the {@link de.tu.darmstadt.informatik.eea.entity.Entity} that is registered as this actions actor.
