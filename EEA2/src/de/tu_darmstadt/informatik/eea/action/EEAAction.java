...
/**
 * EEAActions are used to alter or act a
 * {@link de.tu_darmstadt.informatik.eea.entity.Entity}. Each action has one
 * actor and may have a target entity. Actions can be added to a
 * {@link de.tu_darmstadt.informatik.eea.event.EEAEvent}.
 * 
...
public abstract class EEAAction extends Action {
	 ...
	 * 
	 * @see
	 * com.badlogic.gdx.scenes.scene2d.Action#setActor(com.badlogic.gdx.scenes.
	 * scene2d.Actor)
	 */
	@Override
	 ...
	 * registered as this actions actor.
	 * 
