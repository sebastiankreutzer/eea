...
public class MultiplayerTest {
	...
	public void testSecondPlayerTankValues() {
		...
		assertEquals("Incorrect value of second player tank maximum shot amount", 10, adapter.getSecondPlayerTankMaxShot());
		assertEquals("Incorrect value of second player tank actual shot amount", 5, adapter.getSecondPlayerTankActualShot());
		assertEquals("Incorrect value of second player tank maximum mine amount", 2, adapter.getSecondPlayerTankMaxMine());
		assertEquals("Incorrect value of second player tank actual mine amount", 1, adapter.getSecondPlayerTankActualMine());
		assertEquals("Incorrect value of second player tank strength", 20, adapter.getSecondPlayerTankStrength());
		assertEquals("Incorrect value of second player tank speed", 5, adapter.getSecondPlayerTankSpeed());
		assertEquals("Incorrect value of second player tank rotation", 90, adapter.getSecondPlayerTankRotation());
		assertEquals("Incorrect value of second player tank scale", 10, adapter.getSecondPlayerTankScale());
	...
	public void testSecondPlayerMoveBackward() {
		...
		assertTrue("The second player tank should move backward when pressing s", adapter.getSecondPlayerTankXPosition() < 200);	
		adapter.stopGame();
	}
	...
	public void testSecondPlayerTurnClockwise() {
		...
		assertTrue("The second player tank should turn clockwise when pressing d", adapter.getSecondPlayerTankRotation() > 90);
		adapter.stopGame();
	}
	@Test
	...
	@Test
	public void testSecondPlayerTankScattershot() {
		adapter.initializeGame();
		adapter.loadMapFromFile(new File(map));
		assertTrue("A correct map was detected as incorrect", adapter.isCorrectMap());
		adapter.handleKeyPressN();
