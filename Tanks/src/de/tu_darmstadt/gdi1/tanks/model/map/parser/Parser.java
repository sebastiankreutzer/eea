...
import de.tu_darmstadt.gdi1.tanks.model.factory.BackgroundFactory;
import de.tu_darmstadt.gdi1.tanks.model.factory.BorderFactory;
...
import de.tu_darmstadt.gdi1.tanks.model.factory.TankFactory;
import de.tu_darmstadt.gdi1.tanks.model.factory.TowerFactory;
import de.tu_darmstadt.gdi1.tanks.model.factory.WallFactory;
import de.tu_darmstadt.gdi1.tanks.model.interfaces.IMap;
import de.tu_darmstadt.gdi1.tanks.model.interfaces.IParser;
...
public class Parser implements IParser{
	...
	protected Map parseMine(Map map) throws SyntaxException {
		...
		map.addEntity(new MineFactory(new Vector2f(x, y), scale, strength, debug).createEntity());
		return map;
	}
	...
	protected Map parsePickup(Map map)throws SyntaxException {
		...
		String type = this.accept(Token.IDENTIFIER).getSpelling();
	...
	protected Map parse(Map map) throws SyntaxException {
		...
		map.addEntity(new BackgroundFactory(backGround.substring(1, backGround.length()-1), debug).createEntity());
